...
MESSAGES = {
    "en": {
        ...
        "ai_tta_missing_frames": "TTA fuse finished with {missing} missing frame(s) (allowed {allowed}) — continuing with remaining outputs.",
    ...
    "de": {
        ...
        "ai_tta_missing_frames": "TTA-Fusion beendet mit {missing} fehlenden Frame(s) (erlaubt {allowed}) — arbeite mit vorhandenen Ergebnissen weiter.",
